<template>
  ...
  <AppLayout>
    <div class="py-10">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="mb-6">
          ...
          <button class="px-4 py-2 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition-colors"
            @click="simularNotificacao">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-4 sm:mb-0 tracking-tight">
            <span class="bg-gradient-to-r from-purple-500 to-indigo-600 bg-clip-text text-transparent">Minhas
              Tarefas</span>
          </h1>
        ...
        <div v-if="$page.props.flash && $page.props.flash.mensagem"
          class="mb-6 p-4 rounded-lg border backdrop-blur-lg shadow-lg transition-all duration-500" :class="{
        ...
        <div v-show="showFilters"
          class="mb-6 backdrop-blur-lg bg-white/90 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/10 shadow-lg overflow-hidden transition-all duration-300">
            ...
            <form @submit.prevent="aplicarFiltros">
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <SelectInput id="filtro_prioridade"
                    class="mt-1 block w-full bg-white dark:bg-white/5 border-gray-300 dark:border-white/20 focus:border-indigo-500 focus:ring-indigo-500 rounded-md text-gray-900 dark:text-white"
                ...
                <div>
                  ...
                  <SelectInput id="filtro_categoria"
                    class="mt-1 block w-full bg-white dark:bg-white/5 border-gray-300 dark:border-white/20 focus:border-indigo-500 focus:ring-indigo-500 rounded-md text-gray-900 dark:text-white"
                ...
                <div>
                  ...
                  <TextInput id="filtro_busca" type="text"
                    ...
                    v-model="filtros.busca" placeholder="Título ou descrição" />
                </div>
              </div>
        ...
        <!-- Tabela de Tarefas -->
        <div
          class="backdrop-blur-lg bg-white/90 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/10 shadow-lg overflow-hidden">
          <div class="px-6 py-4 border-b border-gray-200 dark:border-white/10">
              ...
              <div class="mt-2 md:mt-0 flex items-center text-xs text-gray-600 dark:text-gray-400">
                ...
                <div class="flex space-x-3">
                  <div class="flex items-center">
                    <span
                      class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-100 dark:bg-gray-900/30 text-gray-800 dark:text-gray-400 border border-gray-300 dark:border-gray-500/30 mr-1">
                  ...
                  <div class="flex items-center">
                    <span
                      class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 border border-blue-300 dark:border-blue-500/30 mr-1">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M6 10a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z"
                          clip-rule="evenodd" />
                      </svg>
                    </span>
                    <span>Média</span>
                  ...
                  <div class="flex items-center">
                    <span
                      class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-400 border border-orange-300 dark:border-orange-500/30 mr-1">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                  ...
                  <div class="flex items-center">
                    <span
                      class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400 border border-red-300 dark:border-red-500/30 mr-1">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-white/10">
              <thead class="bg-gray-50 dark:bg-white/5">
                <tr>
                  ...
                  <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider hidden md:table-cell">
                    Estado
                  </th>
                  <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider hidden md:table-cell">
                  ...
                  <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider hidden lg:table-cell">
                    Categoria
                  </th>
                  <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider hidden lg:table-cell">
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-white/10 bg-white dark:bg-transparent">
                <tr v-for="tarefa in tarefas.data" :key="tarefa.id"
                    ...
                    <div class="flex items-center">
                      <div>
                        ...
                        <div class="mt-2 md:hidden space-y-2">
                          <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium group relative mr-2"
                            :class="estadoBadgeClasses(tarefa.estado)">
                            <svg v-if="tarefa.estado === 'pendente'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                                clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="tarefa.estado === 'em_progresso'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z"
                                clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="tarefa.estado === 'concluida'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="tarefa.estado === 'cancelada'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                            ...
                            <span
                              class="absolute -top-10 left-1/2 -translate-x-1/2 p-2 bg-gray-900 text-white text-xs rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap z-10">
                              Estado: {{ estadoLabel(tarefa.estado) }}
                            </span>
                          </span>
                          <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium group relative"
                            :class="prioridadeBadgeClasses(tarefa.prioridade)">
                            <svg v-if="tarefa.prioridade === 'baixa'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                              <path d="M3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" />
                            </svg>
                            <svg v-else-if="tarefa.prioridade === 'media'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd" d="M6 10a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z"
                                clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="tarefa.prioridade === 'alta'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                                d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.88-.214.33-.403.713-.57 1.116-.334.804-.614 1.768-.84 2.734a31.365 31.365 0 00-.613 3.58 2.64 2.64 0 01-.945-1.067c-.328-.68-.398-1.534-.398-2.654A1 1 0 005.05 6.05 6.981 6.981 0 003 11a7 7 0 1011.95-4.95c-.592-.591-.98-.985-1.348-1.467-.363-.476-.724-1.063-1.207-2.03zM12.12 15.12A3 3 0 017 13s.879.5 2.5.5c0-1 .5-4 1.25-4.5.5 1 .786 1.293 1.371 1.879A2.99 2.99 0 0113 13a2.99 2.99 0 01-.879 2.121z"
                                clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="tarefa.prioridade === 'urgente'" xmlns="http://www.w3.org/2000/svg"
                              class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd"
                                d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                                clip-rule="evenodd" />
                  ...
                  <td class="px-6 py-4 whitespace-nowrap hidden md:table-cell">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium group relative"
                      :class="prioridadeBadgeClasses(tarefa.prioridade)">
                      <svg v-if="tarefa.prioridade === 'baixa'" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                ...
                <tr v-if="tarefas.data.length === 0">
                  <td colspan="6" class="px-6 py-12 text-center text-gray-400 text-sm">
                    <div class="flex flex-col items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mb-4 text-gray-500" fill="none"
                      ...
                      <Link :href="route('tarefas.create')"
                        class="mt-4 text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
    ...
    <Modal :show="confirmModal.show" @close="confirmModal.show = false">
      <div
        class="p-6 bg-white dark:bg-gray-900 rounded-lg backdrop-blur-lg bg-opacity-80 border border-gray-200 dark:border-white/10">
        ...
        <div class="flex justify-end space-x-3">
          ...
          <DangerButton @click="confirmarExclusao" :disabled="confirmModal.processando">
            Excluir
          </DangerButton>
        </div>
      </div>
...
const simularNotificacao = async () => {
  console.log("Botão clicado - Simulando notificação");
  
  // Criar notificação visual imediatamente (garantindo que algo apareça)
  mostrarNotificacaoVisual("Notificação Push Em funcionamento");
  
  // Tentar também a notificação nativa via Service Worker (sem alertas que interrompem o fluxo)
  try {
    if ('serviceWorker' in navigator) {
      const swReg = await navigator.serviceWorker.ready;
      swReg.showNotification("LaraList", {
        body: "Notificação Push Em funcionamento",
...
// Função para mostrar uma notificação visual na página
const mostrarNotificacaoVisual = (mensagem) => {
  // Criar um elemento de notificação HTML visível na página
  const notificationDiv = document.createElement('div');
  notificationDiv.style.position = 'fixed';
  notificationDiv.style.top = '20px';
  notificationDiv.style.left = '50%';
  notificationDiv.style.transform = 'translateX(-50%)';
  notificationDiv.style.backgroundColor = '#4F46E5';
  notificationDiv.style.color = 'white';
  notificationDiv.style.padding = '15px 20px';
  notificationDiv.style.borderRadius = '8px';
  notificationDiv.style.zIndex = '9999';
  notificationDiv.style.boxShadow = '0 4px 12px rgba(0,0,0,0.25)';
  ...
  notificationDiv.style.width = '350px';
  notificationDiv.style.animation = 'slideInDown 0.3s forwards';
  ...
  notificationDiv.innerHTML = `
    <div style="display: flex; align-items: center;">
      ...
      <div>
        <div style="font-weight: bold; margin-bottom: 5px;">LaraList</div>
        <div>${mensagem}</div>
      </div>
    </div>
    <div style="margin-left: 20px; cursor: pointer;" id="close-notification">✕</div>
  `;
  
  document.body.appendChild(notificationDiv);
  
  // Remover após 5 segundos ou ao clicar no botão fechar
  document.getElementById('close-notification').addEventListener('click', () => {
    notificationDiv.style.animation = 'fadeOut 0.3s forwards';
  ...
  console.log("Notificação visual exibida com sucesso");
