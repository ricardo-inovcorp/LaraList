      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-gray-800 shadow-sm sm:rounded-lg">
          <div class="p-6 bg-gray-800 border-b border-gray-700 text-white">
            <h1 class="text-2xl font-bold mb-6 text-white">Editar Tarefa</h1>
            <form @submit.prevent="submeter">
              ...
              <div class="mb-4">
                <div class="flex items-center">
                  <Checkbox id="concluida" v-model:checked="form.concluida" name="concluida" />
                  <InputLabel for="concluida" value="Marcar como concluída" class="ml-2 text-white" />
                </div>
                <InputError class="mt-2" :message="form.errors.concluida" />
              </div>
...
const form = useForm({
  ...
  categoria: props.tarefa.categoria,
  data_conclusao: props.tarefa.data_conclusao ? new Date(props.tarefa.data_conclusao).toISOString().slice(0, 16) : '',
  concluida: props.tarefa.concluida,
});
